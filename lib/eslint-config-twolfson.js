...
module.exports = {
  ...
  rules: {
    ...
    // SKIPPED: `complexity`
    // Don't enforce consistent return, causes more headaches than saves for callbacks
    // DEV: Anything caught by consistent return will likely be caught in testing
    ...
    'no-multi-assign': OFF,
    'no-multiple-empty-lines': [WARN, {max: 1, maxBOF: 0, maxEOF: 0/* Technically 1 in practice */}],
    ...
    // TODO: Re-enable once PR is resolved
    //   https://github.com/eslint/eslint/pull/8663
