...
module.exports = {
  ...
  rules: {
    ...
    'no-loop-func': WARN,
    // Warn about magic numbers, they can be opted out via comments
    // DEV: When we use ES6, we should enforce const
    'no-magic-numbers': [WARN, {ignoreArrayIndexes: true, enforceConst: false}]
    // Allow multiple spaces when appropriate
    'no-multi-spaces': OFF,
    // TODO: Resume config from here...
