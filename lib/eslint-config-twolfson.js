...
module.exports = {
  ...
  rules: {
    ...
    // TODO: Come back to `func-names` (should only require for certain instances)
    'func-style': OFF,
    ...
    // TODO: Add test about `if/else` spacing
    // TODO: Add test about `function` naming + spacing
    ...
    'one-var': [WARN, {initialized: 'always', uninitialized: 'never'}],
